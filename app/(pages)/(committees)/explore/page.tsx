    ...
    <div>
      ...
      <div className="w-full">
        <div className="max-w-3xl mx-auto text-center pt-20 pb-20 space-y-16">
          ...
          <p className="text-gray-700 ml-4 mr-4 font-geistSans text-lg leading-relaxed">
            acm.explore is one of our committees that focus on bringing new and
            interesting topics to the table. Nothing here is off limits and
            explore captains are given full range of what they want to present
            and work on. This ranges from robotics to game development and more!
          </p>
        </div>
      </div>
      ...
      <div className="w-full px-2 py-20 relative overflow-hidden">
        <div className="max-w-6xl text-center mx-auto space-y-16 relative">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-green-600 font-geistSans mb-4">
              Explore Director
            </p>
          </div>
          {/* Captains Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 place-items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-green-600 font-geistSans mb-4">
                Explore Captain - Game Development
              </p>
            </div>
      ...
      <div className="bg-gradient-to-b from-[#ffffff] via-[#e6f0e8] to-[#ffffff] p-4 pt-20 pb-20 mb-20 space-y-16">
        <div className="flex items-center justify-center mb-10">
          <h2 className="text-3xl font-geistSans font-medium text-black">
            Current Events
          </h2>
        </div>
      ...
      <div className="bg-gray-100 p-4 pt-20 pb-20 mb-20 space-y-16">
        ...
        <div className="flex max-w-6xl mx-auto flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Dive deep into the latest technologies with our hands-on
              workshops. From coding on the Unity Engine to working with
              Arduino, we have you covered.
            </p>
          </div>
        </div>
        ...
        <div className="flex max-w-6xl mx-auto flex-col-reverse md:flex-row items-center gap-8">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              In our presentations, we present on a wide range of topics from
              robotics to game development. We bring in industry professionals
              to speak to our members about their experiences and insights.
            </p>
          </div>
          <div className="md:w-1/2">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="flex max-w-6xl mx-auto flex-col md:flex-row mb-20 items-start gap-8 p-8">
        <div className="md:w-1/2 flex flex-col justify-between min-h-[200px]">
          <div>
            <h2 className="text-3xl font-geistSans font-medium mb-4">
              Have Ideas?
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed">
              We're always looking for new workshop ideas and projects. If you
        ...
        <div className="md:w-1/2 flex flex-col justify-between min-h-[200px]">
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              ...
              No experience required - just bring your curiosity and willingness
              to learn!
            </p>
          </div>
