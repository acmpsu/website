...
export function EventCards({ 
    ...
    return (
        <div className="flex justify-center items-center w-full">
            <div className={`max-w-7xl w-full px-4 ${displayEvents.length === 1 ? 'flex justify-center' : ''}`}>
                <div className={`grid ${gridCols} gap-8 justify-items-center ${displayEvents.length === 1 ? 'w-fit' : 'w-full'}`}>
