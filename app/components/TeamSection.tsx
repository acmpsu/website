...
const renderQuote = (quote: string | { text: string; attribution: string }) => {
  if (typeof quote === "string") {
    return <p className="text-gray-700 italic mt-2">"{quote}"</p>;
  }
  return (
    <div className="mt-2">
      <p className="text-gray-700 italic">{quote.text}</p>
      <p className="text-gray-500 text-sm mt-1">{quote.attribution}</p>
    </div>
  );
};
